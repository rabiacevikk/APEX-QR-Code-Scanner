...
const qrCodeScanner = function (
  ...
  return {
    initialize: function (pConfig) {
      ...
      let html5QrCode, bStr, container$;
      ...
      function init() {
        ...
        if (pConfig.scanFormats != undefined) {
      ...
      apex.region.create(pConfig.regionID, {
